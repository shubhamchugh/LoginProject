        ...
        <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
            <div class="media d-flex align-items-start">
              <div class="media-left">
                <div class="avatar"><img src="{{asset('images/portrait/small/avatar-s-15.jpg')}}" alt="avatar"
            ...
            <div class="media d-flex align-items-start">
              <div class="media-left">
                <div class="avatar"><img src="{{asset('images/portrait/small/avatar-s-3.jpg')}}" alt="avatar" width="32"
                    height="32"></div>
              </div>
              <div class="media-body">
                <p class="media-heading"><span class="font-weight-bolder">New message</span>&nbsp;received</p><small
    ...
    <li class="nav-item dropdown dropdown-user">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
        ...
        <a class="dropdown-item" href="{{ route('api-tokens.index') }}">
          <i class="mr-50" data-feather="code"></i> {{ __('API Tokens') }}
        </a>
        @endif
        ...
        <a class="dropdown-item">
          <i class="mr-50" data-feather="users"></i> {{ __('Manage Team') }}
        </a>
        <!-- Team Settings -->
