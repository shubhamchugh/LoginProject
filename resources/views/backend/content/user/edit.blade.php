...
<section class="content">
    <div class="row">
        ...
        <form method="POST" action="{{ route('user.update', $user->id)}}" id="post-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
    ...
    <div class="card">
        <div class="card-body">
            <ul class="nav nav-pills" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" id="password-tab" data-toggle="tab" href="#password"
                        aria-controls="password" role="tab" aria-selected="false">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="password" aria-labelledby="password-tab" role="tabpanel">
                    <!-- users edit password form start -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group form-password-toggle input-group-merge">
                                        <input type="password" class="form-control" id="account-retype-new-password"
                                            name="confirm-new-password" placeholder="New Password" />
                                        <div class="input-group-append">
