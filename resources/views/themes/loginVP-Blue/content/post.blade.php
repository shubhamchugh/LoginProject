        ...
        <div class="col-md-8">
            ...
            <div class="card" style="margin-top:5px;border:none;">
                ...
                <div class="card-body" style="background-color: #E8CEBF;margin-bottom:15px;border:none;">
                    <div class="col-xs-12 col-sm-12 col-md-12 overallPadd answer_inner">
                        <div class="col-xs-12 col-sm-12 row col-md-12 content_inner"
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 contentPadd">
                                ...
                                <h3 class="results">
                                    <a href="#" rel='nofollow' style="background-color:#241e0400;">
                                        {{ $content->content_title }} </a>
                                </h3>
                                <div style="color:#28a745;word-wrap:break-word;font-size:14px;color:#28a745;">
                                    <span style="color:#fff;">Url:</span> {{ $content->content_url }}
                                </div>
                                <br>
                                <div style=" font-size: 18px;color:#e9ecef;">
                                    {{ $content->content_dec }}
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 contentPadd">
                                ...
                                <h3 class="results">
                                    <a href="#" rel='nofollow' style="background-color:#f6d53b;">
                                        {{ $content->content_title }} </a>
                                </h3>
                                <div style="color:#28a745;word-wrap:break-word;font-size:14px;color:#28a745;">
                                    <span style="color:#fff;">Url:</span> {{ $content->content_url }}
                            ...
                            <div class="row flex" style="margin:10px 0 0 0!important;padding:2px !important;">
                                <div class="Third sectional">
                                    ...
                                    <p class="small data">
                                        {{-- <i class="fa fa-location-arrow exInfo pull-left"></i><span
                                            class="delta rank up pull-right" style="background-color:#f0ad4e;">
                                        </span> --}}
                                ...
                                <div class="Third sectional">
                                    ...
                                    <p class="small data">
                                        {{-- <i class="fa fa-eye exInfo pull-left"></i><span
                    ...
                    <a href="{{ $content->content_url }}" style="float:right" rel="nofollow" target="_blank"
                        class="w-25 btn btn-sm btn btn-success py-1 btn__primary text-truncate">
                        Visit Site</a>
                </div>
