...
<div class="col-md-2 col-xs-12">
    <div class="share">
        ...
        <ul>
            <li>
                <a target="_blank"
                    href="https://twitter.com/intent/tweet?text={{ $post->post_title ?? "" }}&url={{ $url_current }}&original_referer={{ $url_current }}">
            ...
            <li>
                <a target="_blank" href="https://www.facebook.com/sharer.php?u={{ $url_current }}">
                    <svg class="svgIcon-use" width="29" height="29" viewbox="0 0 29 29">
                        <path
