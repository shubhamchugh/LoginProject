    ...
    <div class="container single-col-max-width">
        ...
        <div class="blog-post-body">
            ...
            @if (config('constant.Bing_SERP_TOP') == true && 0 <
                ...
                config('constant.Bing_SERP_TOP_COUNT'); $i++) <div class="alert alert-warning">
                <h3 class="text-primary cursorp">{{ $i+1 }}.{{ $bing_search_result_title[$i] ?? "" }}
                </h3>
                <p>

                    <span class="badge bg-warning">{{rand(1,36)}} hours ago</span>
        ...
        @for($i = 0; $i < count(is_countable($bing_paa_questions)?$bing_paa_questions:[]); $i++) <h2 class="mt-5 mb-3">
            ...
            @for($i = 0; $i < count(is_countable($google_faq_questions)?$google_faq_questions:[]); $i++) <h2
                ...
                @for($i = 0; $i < count(is_countable($bing_slider_faq_questions)?$bing_slider_faq_questions:[]); $i++)
                    <h2 class="mt-5 mb-3">
                    ...
                    @for($i = 0; $i < count(is_countable($bing_pop_faq_questions)?$bing_pop_faq_questions:[]); $i++) <h2
                        ...
                        true))
                        @for($i = 0; $i < count(is_countable($bing_tab_faq_questions)?$bing_tab_faq_questions:[]); $i++)
                            <h2 class="mt-5 mb-3">
