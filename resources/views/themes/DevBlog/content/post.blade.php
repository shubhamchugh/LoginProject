...
<article class="blog-post px-3 py-5 p-md-5">
    <div class="container single-col-max-width">
        ...
        <div class="blog-post-body">
            ...
            <h1>bing People also ask</h1>
            {{-- Bing People Also Aks --}}
            @if ((config('constant.bing_paa') == true) && !empty($bing_paa_questions[0]))
            @for($i = 0; $i < count(is_countable($bing_paa_questions)?$bing_paa_questions:[]); $i++) <h3
                class="mt-5 mb-3">
                ...
                @for($i = 0; $i < count(is_countable($google_faq['questions'][0])?$google_faq['questions'][0]:[]); $i++)
                    <h3 class="mt-5 mb-3">
                    ...
                    @endfor
                    <h1>Bing video under google Faq</h1>
                    {{-- Bing Random videostart--}}
                    ...
                    @for($i = 0; $i < count(is_countable($bing_slider_faq_questions)?$bing_slider_faq_questions:[]);
                        ...
                        <h1>google keywords under slider Faq</h1>
                        ...
                        @for($i = 0; $i < count(is_countable($bing_pop_faq_questions)?$bing_pop_faq_questions:[]); $i++)
                            ...
                            @endfor
                            <h1>Bing image under pop Faq</h1>
                            {{-- Bing Random Image start--}}
                            ...
                            <h1>Bing bing_tab_faq_questions question start</h1>
                            {{-- Bing Slider Questions start--}}
