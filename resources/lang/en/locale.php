...
return [
    "General Settings"    => "General Settings",      // backend menu
    "Basic Configuration" => "Basic Configuration",   // backend menu
    "Dashboard"           => "Dashboard",             // backend menu
    "Post Management"     => "Post Management",       //backend menu
    "Post"                => "Post",                  //backend menu
    "All Post"            => "All Post",              //backend menu
    "Page Management"     => "Page Management",       //backend menu
    "Page"                => "Page",                  //backend menu
    "Add New"             => "Add New",               //backend menu
    "All Pages"           => "All Pages",             //backend menu
    "All Users"           => "All Users",             //backend menu
    "Scraping"            => "Scraping",
