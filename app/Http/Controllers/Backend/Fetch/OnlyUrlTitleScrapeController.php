...
class OnlyUrlTitleScrapeController extends Controller
{
    public function OnlyUrlTitle(Request $request)
    {
        ...
        if (empty($refKey)) {
            ...
            FullURL Example: http://domain.com/scrape/onlyurltitle?&refKey=loginspy&start=1&end=100");
        }
