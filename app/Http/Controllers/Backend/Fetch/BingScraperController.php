...
class BingScraperController extends Controller
{
    public function BingScraper(Request $request)
    {
        ...
        if (!empty($source_url->url)) {
            ...
            if (empty($duplicate_check)) {
                ...
                $titles      = $pokemon_xpath->query('/html/body/div[2]/span[1]/ol/li[*]/h2/a');
                $decs        = $pokemon_xpath->query('/html/body/div[2]/span[1]/ol/li[*]/div/p/text()');
                $urls        = $pokemon_xpath->query('/html/body/div[2]/span[1]/ol/li[*]/h2/a/@href');
                $posts_title = $pokemon_xpath->query('/html/body/div[1]/form/div/input[1]/@value');
