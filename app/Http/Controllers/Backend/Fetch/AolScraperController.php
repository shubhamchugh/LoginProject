...
class AolScraperController extends Controller
{
    public function AolScraper(Request $request)
    {
        ...
        if (!empty($source_url->url)) {
            ...
            if (empty($duplicate_check)) {
                ...
                $titles      = $pokemon_xpath->query('/html/body/div[1]/div[3]/div/div/div[1]/div/div/div/div/ol/li[*]/div/div[1]/h3/a');
                $decs        = $pokemon_xpath->query('/html/body/div[1]/div[3]/div/div/div[1]/div/div/div/div/ol/li[*]/div/div[2]/p');
                $urls        = $pokemon_xpath->query('/html/body/div[1]/div[3]/div/div/div[1]/div/div/div/div/ol/li[*]/div/div[1]/h3/a/@href');
                $posts_title = $pokemon_xpath->query('/html/body/div[1]/div[1]/div/div[2]/form/div/input/@value');
